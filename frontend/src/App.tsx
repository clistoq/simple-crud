  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <div className="container mx-auto px-4 py-12 max-w-2xl">
        ...
        <div className="mt-8 text-center text-purple-300/70 text-sm">
          <p>Backend: Zig HTTP Server on port 8080</p>
          <p>Frontend: React + Vite + Tailwind CSS</p>
          <p className="mt-2 text-purple-400">Run with: <code className="bg-white/10 px-2 py-1 rounded">docker-compose up --build</code></p>
        </div>
      </div>
    </div>
  );
